...
DECLARE table_name STRING DEFAULT 'dim_compset_demand';
...
EXECUTE IMMEDIATE FORMAT("""
  CREATE OR REPLACE TABLE `%s.%s.%s` (
    ...
    cs_available_rooms_string STRING OPTIONS(description='Standardized cs_available_rooms_string.'),
    cs_available_rooms INT64 OPTIONS(description='Standardized cs_available_rooms.'),
