CREATE OR REPLACE VIEW `aparium-dataflow.FinanceData.FilteredLookerActualsV`
AS SELECT 
    snapshot_date,
    property_code,
    property_name,
    ...
    segment_name,
    metric,
    'Actuals' AS data_source,  -- Explicitly setting data_source
    available_rms,
...
FROM `aparium-dataflow.FinanceData.FinanceActuals`
